/**
    The Guitar shape is a composite shape created using multiple shapes to create the guitar. Can be seen
    on the backgroundstage along witrh the other instruments.
