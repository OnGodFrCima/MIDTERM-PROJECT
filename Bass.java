/**
	A composite shape made to look like the bass instrument. Multiple shapes were used to make the shape of the 
    bass which can be seen in the inside of the bar.
