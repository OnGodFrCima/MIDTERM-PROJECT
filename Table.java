/**
    A composite shape made to look like a table. Also indicates where the buttons located in the scene canvas are that activates the
    audioplayers. Very useful.
