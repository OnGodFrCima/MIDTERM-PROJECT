/**
    A pattern made using lines. Used to seperate the floor from the walls in the background as well as add character
    to the background and improve aesthetic.
